...
ALTER TABLE reply
	ADD CONSTRAINT board_bno_fk FOREIGN KEY (bno)
...
ALTER TABLE admins
	ADD CONSTRAINT admins_id_fk FOREIGN KEY (id)
	REFERENCES members (id)
;


ALTER TABLE board
	ADD CONSTRAINT members_id_pk FOREIGN KEY (writer)
	REFERENCES members (id)
;
...
ALTER TABLE reply
	ADD CONSTRAINT reply_rno_fk FOREIGN KEY (reply_writer)
	REFERENCES members (id)
;
